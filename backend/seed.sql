-- Data seed export generated from current database state
...
INSERT INTO `bmi_calculations` (`id`, `age`, `height_cm`, `weight_kg`, `gender`, `unit_system`, `exercise_index`, `bmi_value`, `bmi_category`, `created_at`) VALUES (1,23,159.00,55.00,'Female','Metric',1,21.80,'Normal','2026-02-24 05:48:52'),(2,23,159.00,55.00,'Male','Metric',0,21.80,'Normal','2026-02-24 05:49:39');
